...
import MqNavItemDropdownBody from "../Components/MqNavItemDropdownBody";
import Placeholder from "../../assets/images/placeholders/placeholder.jpg";

class DefaultMainNavBar extends  Component{
  constructor(props){
    super(props)
  }
  changeStateSideBar(){
    let body = document.querySelector('body')
    if(!body.classList.contains('sidebar-xs')){
      document.querySelector('body').classList.add('sidebar-xs')
    }else{
      document.querySelector('body').classList.remove('sidebar-xs')
    }
  }
  render() {
    return(
      <div className="navbar navbar-expand-md navbar-dark">
        ...
        <div className="d-md-none">
          ...
          <button className="navbar-toggler sidebar-mobile-component-toggle" type="button">
            <i className="icon-unfold"></i>
          </button>
        </div>

        <div className="collapse navbar-collapse" id="navbar-mobile">
          <MqNav className="navbar-nav">
            <MqNavItem className="nav-item">
              <a href="javascript:void(0)" onClick={() => {this.changeStateSideBar()}} className="navbar-nav-link sidebar-control sidebar-main-toggle d-none d-md-block">
                <i className="icon-paragraph-justify3"></i>
              </a>
            </MqNavItem>
            <MqNavItem className="nav-item dropdown">
              <MqNavItemHead className="navbar-nav-link dropdown-toggle caret-0">
              ...
              <MqNavItemDropdownBody className="dropdown-menu dropdown-content wmin-md-350">
                ...
                <div className="dropdown-content-body dropdown-scrollable">
                  <ul className="media-list">
                    ...
                    <li className="media">
                      <div className="mr-3">
                        <a href="#"
                           className="btn bg-transparent border-warning text-warning rounded-round border-2 btn-icon"><i
                    ...
                    <li className="media">
                      <div className="mr-3">
                        <a href="#"
                           className="btn bg-transparent border-info text-info rounded-round border-2 btn-icon"><i
                          className="icon-git-branch"></i></a>
                      </div>

                      <div className="media-body">
                        <a href="#">Chris Arney</a> created a new <span
                        className="font-weight-semibold">Design</span> branch
                    ...
                    <li className="media">
                      ...
                      <div className="media-body">
                        ...
                        className="font-weight-semibold">Master</span> and <span
                        className="font-weight-semibold">Dev</span> branches
                ...
                <div className="dropdown-content-footer bg-light">
                  ...
                  <div>
                    <a href="#" className="text-grey" data-popup="tooltip" title="Mark all as read"><i
                      className="icon-radio-unchecked"></i></a>
                    <a href="#" className="text-grey ml-2" data-popup="tooltip" title="Bug tracker"><i
                      className="icon-bug2"></i></a>
                  </div>
                </div>
              </MqNavItemDropdownBody>
            </MqNavItem>
          </MqNav>
          ...
          <MqNav className="navbar-nav">
            <MqNavItem hideoutclick className="nav-item dropdown">
              <MqNavItemHead href="#" className="navbar-nav-link dropdown-toggle caret-0" data-toggle="dropdown">
                <i className="icon-people"></i>
                <span className="d-md-none ml-2">Users</span>
              </MqNavItemHead>

              <MqNavItemDropdownBody className="dropdown-menu dropdown-menu-right dropdown-content wmin-md-300">
                <div className="dropdown-content-header">
                ...
                <div className="dropdown-content-body dropdown-scrollable">
                  <ul className="media-list">
                    <li className="media">
                      <div className="mr-3">
                        <img src={Placeholder} width="36"
                             height="36" className="rounded-circle" alt=""/>
                      </div>
                      <div className="media-body">
                      ...
                      <div className="ml-3 align-self-center"><span
                        className="badge badge-mark border-success"></span></div>
                    </li>
                    ...
                    <li className="media">
                      ...
                      <div className="ml-3 align-self-center"><span className="badge badge-mark border-danger"></span>
                      </div>
                    </li>
                    ...
                    <li className="media">
                      ...
                      <div className="ml-3 align-self-center"><span
                        className="badge badge-mark border-warning-300"></span></div>
                    </li>
                    ...
                    <li className="media">
                      ...
                      <div className="ml-3 align-self-center"><span
                        className="badge badge-mark border-grey-400"></span></div>
                    </li>
                  </ul>
                </div>
            ...
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu dropdown-menu-right dropdown-content wmin-md-350">
                ...
                <div className="dropdown-content-footer justify-content-center p-0">
                  <a href="#" className="bg-light text-grey w-100 py-2" data-popup="tooltip" title="Load more"><i
                    className="icon-menu7 d-block top-0"></i></a>
                </div>
              </div>
            </li>
            <li className="nav-item dropdown dropdown-user">
              <a href="#" className="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
                <img src={Placeholder} className="rounded-circle"
                     alt=""/>
                <span>Victoria</span>
              </a>
...
export default DefaultMainNavBar
