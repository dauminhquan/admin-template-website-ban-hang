              ...
              <div className="card">
                ...
                <div className="card-body d-sm-flex align-items-sm-center justify-content-sm-between flex-sm-wrap">
                  <div className="d-flex align-items-center mb-3 mb-sm-0">
                    ...
                    <div className="ml-3">
                      <h5 className="font-weight-semibold mb-0">38,289 <span
                        className="text-success font-size-sm font-weight-normal"><i className="icon-arrow-up12"></i> (+16.2%)</span>
                      </h5>
                  ...
                  <div className="d-flex align-items-center mb-3 mb-sm-0">
                    ...
                    <div className="ml-3">
                      <h5 className="font-weight-semibold mb-0">2,458 <span
                        className="text-danger font-size-sm font-weight-normal"><i className="icon-arrow-down12"></i> (-4.9%)</span>
                      </h5>
                  ...
                  <div>
                    <a href="#" className="btn bg-indigo-300"><i className="icon-statistics mr-2"></i> View report</a>
                  </div>
                </div>
                ...
                <div className="table-responsive">
                  ...
                  {/*        <div className="mr-3">*/}
                  {/*          <a href="#">*/}
                  {/*            <img src="../../../../global_assets/images/brands/facebook.png" className="rounded-circle"*/}
                  ...
                  {/*            <a href="#" className="dropdown-item"><i className="icon-file-stats"></i> View statement</a>*/}
                  {/*            <a href="#" className="dropdown-item"><i className="icon-file-text2"></i> Edit campaign</a>*/}
                  {/*            <a href="#" className="dropdown-item"><i className="icon-file-locked"></i> Disable campaign</a>*/}
                  {/*            <div className="dropdown-divider"></div>*/}
                  {/*            <a href="#" className="dropdown-item"><i className="icon-gear"></i> Settings</a>*/}
                  {/*          </div>*/}
                  {/*        </div>*/}
                  {/*      </div>*/}
                  {/*    </td>*/}
                  ...
                  {/*        <div className="mr-3">*/}
                  {/*          <a href="#">*/}
                  {/*            <img src="../../../../global_assets/images/brands/youtube.png" className="rounded-circle"*/}
                  {/*                 width="32" height="32" alt="" />*/}
                  {/*          </a>*/}
                  {/*        </div>*/}
                  {/*        <div>*/}
                  ...
                  {/*        <div className="mr-3">*/}
                  {/*          <a href="#">*/}
                  {/*            <img src="../../../../global_assets/images/brands/spotify.png" className="rounded-circle"*/}
                  {/*                 width="32" height="32" alt="" />*/}
                  {/*          </a>*/}
                  {/*        </div>*/}
                  {/*        <div>*/}
                  ...
                  {/*        <div className="mr-3">*/}
                  {/*          <a href="#">*/}
                  {/*            <img src="../../../../global_assets/images/brands/twitter.png" className="rounded-circle"*/}
                  {/*                 width="32" height="32" alt="" />*/}
                  {/*          </a>*/}
                  {/*        </div>*/}
                  {/*        <div>*/}
                  ...
                  {/*        <div className="mr-3">*/}
                  {/*          <a href="#">*/}
                  {/*            <img src="../../../../global_assets/images/brands/bing.png" className="rounded-circle"*/}
                  {/*                 width="32" height="32" alt="" />*/}
                  {/*          </a>*/}
                  {/*        </div>*/}
                  {/*        <div>*/}
                  ...
                  {/*        <div className="mr-3">*/}
                  {/*          <a href="#">*/}
                  {/*            <img src="../../../../global_assets/images/brands/amazon.png" className="rounded-circle"*/}
                  {/*                 width="32" height="32" alt="" />*/}
                  {/*          </a>*/}
                  {/*        </div>*/}
                  {/*        <div>*/}
                  ...
                  {/*        <div className="mr-3">*/}
                  {/*          <a href="#">*/}
                  {/*            <img src="../../../../global_assets/images/brands/dribbble.png" className="rounded-circle"*/}
                  {/*                 width="32" height="32" alt="" />*/}
                  {/*          </a>*/}
                  {/*        </div>*/}
                  {/*        <div>*/}
